...
setGeneric( name = "multisegmean"          ,def = function(.Object,CGHo,uniKmax,multiKmax,cl){standardGeneric("multisegmean")})
setGeneric( name = "multisegmixt"          ,def = function(.Object,CGHo,uniKmax,multiKmax,phi,cl){standardGeneric("multisegmixt")})
